...
namespace AkvatoriaModel
{
    public class UMSL : FastAbstractObject
    {
        ...
        public UMSL(RobotSpawn spawn, TimeSpan timeSpan, AkvatoriaWrapper wrapper, RobotConfig robotConfig, RobotTasks robotTasks)
        {
            this.spawn = spawn;
